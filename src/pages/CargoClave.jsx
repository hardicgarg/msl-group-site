        ...
        <div className="animate-fade-in">
            ...
            <div id="contact" className="py-24 bg-slate-50 relative overflow-hidden">
                ...
                <div className="container relative z-10 flex flex-col items-center justify-center text-center">
                    ...
                    <button className="btn bg-indigo-600 text-white hover:bg-indigo-700 px-10 py-5 rounded-full font-bold text-lg flex items-center gap-3 transition-all hover:gap-5 shadow-lg hover:shadow-indigo-500/25 transform hover:-translate-y-1">
