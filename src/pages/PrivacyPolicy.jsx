        ...
        <div className="bg-white min-h-screen pt-32 pb-16 px-6 md:px-12 lg:px-24">
            <div className="max-w-4xl">
                ...
                <div className="prose prose-slate max-w-none">
                    ...
                    <h2 className="text-3xl font-bold text-slate-900 mb-6">Interpretation and Definitions</h2>

                    <h3 className="text-2xl font-bold text-slate-900 mb-4">Interpretation</h3>
                    <p className="text-slate-700 mb-8 leading-relaxed">
                        The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
                    </p>

                    <h3 className="text-2xl font-bold text-slate-900 mb-4">Definitions</h3>
                    <p className="text-slate-700 mb-6">For the purposes of this Privacy Policy:</p>
