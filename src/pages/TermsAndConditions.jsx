...
const TermsAndConditions = () => {
    return (
        <div className="bg-white min-h-screen pt-32 pb-16 px-6 md:px-12 lg:px-24">
            <div className="max-w-4xl">
                <h1 className="text-4xl font-bold text-slate-900 mb-2">Terms and Conditions</h1>
                <p className="text-slate-500 mb-8">Last updated: July 04, 2024</p>
                ...
                <div className="prose prose-slate max-w-none">
                    ...
                    <h2 className="text-3xl font-bold text-slate-900 mb-6 mt-12">Disclaimer of Warranties</h2>
                    ...
                    <h2 className="text-3xl font-bold text-slate-900 mb-6 mt-12">Changes to Terms and Conditions</h2>
                    <p className="text-slate-700 mb-8 leading-relaxed">
                    ...
                    <h2 className="text-3xl font-bold text-slate-900 mb-6 mt-12">Submissions and Ideas</h2>
                    <p className="text-slate-700 mb-8 leading-relaxed">
                    ...
                    <h2 className="text-3xl font-bold text-slate-900 mb-6 mt-12">Links to Third-Party Sites</h2>
                    <p className="text-slate-700 mb-8 leading-relaxed">
                    ...
                    <h2 className="text-3xl font-bold text-slate-900 mb-6 mt-12">Trademarks and Copyrights</h2>
                    <p className="text-slate-700 mb-6 leading-relaxed">
